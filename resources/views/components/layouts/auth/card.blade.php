                    ...
                    <div class="hidden overflow-hidden rounded-[32px] border border-slate-700/40 bg-slate-900/90 p-10 shadow-[0_40px_120px_-40px_rgba(0,0,0,0.45)] backdrop-blur-xl lg:flex lg:flex-col lg:justify-between">
                        <div class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-sm leading-6 text-slate-400">A calm, focused place to sign in and manage your account with confidence.</p>
                            </div>
                        </div>
                        <div class="space-y-4 text-sm leading-6 text-slate-400">
                            <p class="uppercase tracking-[0.24em] text-slate-500">Minimal, modern, responsive</p>
                            <ul class="space-y-3">
                                <li class="flex gap-3"><span class="mt-1 h-2.5 w-2.5 rounded-full bg-slate-700"></span><span>Clear call to action and clean form surface.</span></li>
                                <li class="flex gap-3"><span class="mt-1 h-2.5 w-2.5 rounded-full bg-slate-700"></span><span>Soft edge borders and subtle glass effect.</span></li>
                                <li class="flex gap-3"><span class="mt-1 h-2.5 w-2.5 rounded-full bg-slate-700"></span><span>Easy reading on light and dark themes.</span></li>
                            </ul>
                        </div>
                    </div>
