    ...
    <head>
        ...
        <style>
            * {
            ...
            @media (hover:hover) {
                .nav-links a.primary:hover, .nav-links button.primary:hover {
                    background: #1e293b;
                }
            }

            .nav-links a.secondary, .nav-links button.secondary {
            ...
            @media (hover:hover) {
                .nav-links a.secondary:hover, .nav-links button.secondary:hover {
                    background: #f1f5f9;
                }
            }
    ...
    <body>
        ...
        <nav>
            <div class="nav-container">
                ...
                <div class="nav-links">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="tertiary">Log in</a>
        ...
        <section class="hero">
            <div class="hero-content">
                <h1>Welcome to Your <span class="gradient-text">Modern Platform</span></h1>
                <p class="hero-description">
                    Build amazing experiences with our powerful, intuitive platform. Get started today and see the difference.
                </p>
            ...
            <div class="section-container">
                ...
                <div class="features-grid">
                    ...
                    <div class="feature-card">
                        <div class="feature-icon">🔒</div>
                        <h3>Secure</h3>
                        <p>Bank-level security to keep your data safe and protected 24/7.</p>
                    </div>
                    <div class="feature-card">
                        <div class="feature-icon">📱</div>
                        <h3>Responsive</h3>
